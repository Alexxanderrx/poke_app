...
function CardPokemon({ url }) {
    ...
    const [dataPokemon, setDataPokemon] = useState(false);
    ...
    return (
        <Link className="cardFondo" href={`info/${dataPokemon.id}`} target="_blank" >
            {loading ? (
                ...
                <div className="cardPokemon" >
                    <div>
                        <img src={imagePokemon} alt="Img_pokemon" />
                    </div>
